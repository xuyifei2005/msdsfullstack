...
def debug_regulatory():
    ...
    print("法规信息原始内容:")
    print("=" * 80)
    print(regulatory_content)
    print("=" * 80)
    
    # 按行分析内容
    lines = regulatory_content.split('\n')
    ...
    # 生成XML并检查结果
    output_path = r"D:\XUYIFEI\XUPROJECTS\msdsfullstack\pdf2xml\test_regulatory_fix.xml"
    ...
    with open(output_path, 'r', encoding='utf-8') as f:
        ...
        lines = content.split('\n')
        for i, line in enumerate(lines):
            if 'regulatory' in line or 'regulatory_info' in line:
