...
**💰 费用说明：** 
- ✅ **个人实例版：完全免费**（✨推荐使用，足够本项目使用）
  - 3个命名空间（我们只需1个）
  - 每个命名空间300个镜像仓库
  - 每月10GB免费流量
  - 前10GB存储空间免费
  - **无需购买，开通即用**
- 💳 **企业版实例：付费服务**（约300-2000元/月）
  - 仅大型企业需要
  - 提供专属实例和更高性能
  - 我们的项目不需要
...
5. 设置或获取**固定密码**（如果没有设置过）
   - 用户名：阿里云账号全名（从"访问凭证"页面复制）
   - 密码：您设置的固定密码（**注意：不是阿里云登录密码**）

**⚠️ 安全警告：永远不要在代码或文档中填写实际的账号密码！直接在GitHub Secrets中配置。**
