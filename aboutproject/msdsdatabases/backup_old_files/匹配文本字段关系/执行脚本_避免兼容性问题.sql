-- =============================================
-- MSDS数据库安全执行脚本
-- 解决MySQL sql_mode兼容性问题
-- =============================================

-- 首先保存当前的SQL模式
SET @old_sql_mode = @@sql_mode;

-- 设置兼容的SQL模式，避免ONLY_FULL_GROUP_BY等严格模式问题
SET SESSION sql_mode = 'TRADITIONAL,NO_AUTO_VALUE_ON_ZERO';

-- 如果是MySQL 8.0+，还需要处理一些额外的模式
SET SESSION sql_mode = REPLACE(@@sql_mode, 'ONLY_FULL_GROUP_BY', '');

-- =============================================
-- 直接创建数据库和表结构（避免SOURCE命令的编码问题）
-- =============================================
