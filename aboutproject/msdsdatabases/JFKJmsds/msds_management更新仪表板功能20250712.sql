...
-- ----------------------------
-- Table structure for msds_access_log
-- ----------------------------
DROP TABLE IF EXISTS `msds_access_log`;
CREATE TABLE `msds_access_log` (
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='访问日志表';

-- ----------------------------
-- Records of msds_access_log
-- ----------------------------
INSERT INTO `msds_access_log` VALUES ('1', '1', '1', 'view', '192.168.1.100', null, '2025-07-11 06:04:05', null);
INSERT INTO `msds_access_log` VALUES ('2', '1', '2', 'view', '192.168.1.100', null, '2025-07-10 06:04:05', null);
INSERT INTO `msds_access_log` VALUES ('3', '2', '1', 'view', '192.168.1.101', null, '2025-07-09 06:04:05', null);
INSERT INTO `msds_access_log` VALUES ('4', '2', '3', 'download', '192.168.1.101', null, '2025-07-11 06:04:05', null);
INSERT INTO `msds_access_log` VALUES ('5', '3', '2', 'view', '192.168.1.102', null, '2025-07-12 06:04:05', null);
...
-- ----------------------------
-- Table structure for msds_chemical
-- ----------------------------
DROP TABLE IF EXISTS `msds_chemical`;
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='化学品信息表';

-- ----------------------------
-- Records of msds_chemical
-- ----------------------------
INSERT INTO `msds_chemical` VALUES ('1', '乙醇', '64-17-5', 'C2H6O', '46.0684', 'low', '有机溶剂', '上海化工有限公司', null, '', null, '', null, null);
INSERT INTO `msds_chemical` VALUES ('2', '甲醇', '67-56-1', 'CH4O', '32.0419', 'medium', '有机溶剂', '北京化学试剂厂', null, '', null, '', null, null);
INSERT INTO `msds_chemical` VALUES ('3', '丙酮', '67-64-1', 'C3H6O', '58.0791', 'medium', '有机溶剂', '广州试剂公司', null, '', null, '', null, null);
INSERT INTO `msds_chemical` VALUES ('4', '苯', '71-43-2', 'C6H6', '78.1118', 'high', '芳香烃', '天津化工集团', null, '', null, '', null, null);
INSERT INTO `msds_chemical` VALUES ('5', '甲苯', '108-88-3', 'C7H8', '92.1384', 'medium', '芳香烃', '深圳化学有限公司', null, '', null, '', null, null);
...
-- ----------------------------
-- Table structure for msds_document
-- ----------------------------
DROP TABLE IF EXISTS `msds_document`;
CREATE TABLE `msds_document` (
  ...
  `remark` varchar(500) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='MSDS文档表';

-- ----------------------------
-- Records of msds_document
-- ----------------------------
INSERT INTO `msds_document` VALUES ('1', '乙醇安全技术说明书', '有机溶剂', '1', null, 'PDF', null, '1', '2027-07-12 06:04:00', '', null, '', null, null);
INSERT INTO `msds_document` VALUES ('2', '甲醇安全技术说明书', '有机溶剂', '2', null, 'PDF', null, '1', '2027-07-12 06:04:00', '', null, '', null, null);
INSERT INTO `msds_document` VALUES ('3', '丙酮安全技术说明书', '有机溶剂', '3', null, 'PDF', null, '1', '2027-07-12 06:04:00', '', null, '', null, null);
INSERT INTO `msds_document` VALUES ('4', '苯安全技术说明书', '芳香烃', '4', null, 'PDF', null, '0', '2027-07-12 06:04:00', '', null, '', null, null);
INSERT INTO `msds_document` VALUES ('5', '甲苯安全技术说明书', '芳香烃', '5', null, 'PDF', null, '1', '2027-07-12 06:04:00', '', null, '', null, null);

-- ----------------------------
-- Table structure for msds_download_log
-- ----------------------------
DROP TABLE IF EXISTS `msds_download_log`;
CREATE TABLE `msds_download_log` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '日志ID',
  `user_id` bigint(20) DEFAULT NULL COMMENT '用户ID',
  `document_id` bigint(20) DEFAULT NULL COMMENT '文档ID',
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='下载日志表';

-- ----------------------------
-- Records of msds_download_log
-- ----------------------------
INSERT INTO `msds_download_log` VALUES ('1', '1', '1', 'pdf', '1024000', 'success', '192.168.1.100', '2025-07-11 06:04:09');
INSERT INTO `msds_download_log` VALUES ('2', '2', '3', 'pdf', '2048000', 'success', '192.168.1.101', '2025-07-11 06:04:09');
INSERT INTO `msds_download_log` VALUES ('3', '3', '2', 'pdf', '1536000', 'success', '192.168.1.102', '2025-07-12 06:04:09');
INSERT INTO `msds_download_log` VALUES ('4', '1', '5', 'pdf', '1792000', 'success', '192.168.1.100', '2025-07-12 06:04:09');
INSERT INTO `msds_download_log` VALUES ('5', '2', '1', 'pdf', '1024000', 'success', '192.168.1.101', '2025-07-12 04:04:09');
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='MSDS主信息表';

-- ----------------------------
-- Records of msds_main
-- ----------------------------
INSERT INTO `msds_main` VALUES ('3', '115-29-7', 'MSDS#1597', '(1,4,5,6,7,7-六氯-8,9,10-三降', '1,2,3,4,7,7-六氯双环[2,2,1]', '1,2,3,4,7,7-hexachloro-8,9,10', null, '名称： 供应商地址：', '供应商电话： 供应商应急电话：', null, '供应商Email：', '供应商应急电话：', '第二部分：危险性概述', '供应商传真： 供应商Email：', null, null, null, null, null, 'draft', null, null, '1', '2025-07-09 19:59:19', '2025-07-09 19:59:19', null, null, null);
...
) ENGINE=InnoDB AUTO_INCREMENT=129 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='系统访问记录';
...
INSERT INTO `sys_logininfor` VALUES ('118', 'admin', '127.0.0.1', '内网IP', 'Chrome 13', 'Windows 10', '0', '登录成功', '2025-07-07 11:01:58');
INSERT INTO `sys_logininfor` VALUES ('119', 'admin', '127.0.0.1', '内网IP', 'Chrome 13', 'Windows 10', '0', '登录成功', '2025-07-09 15:25:13');
INSERT INTO `sys_logininfor` VALUES ('120', 'admin', '127.0.0.1', '内网IP', 'Chrome 13', 'Windows 10', '0', '登录成功', '2025-07-09 15:25:31');
INSERT INTO `sys_logininfor` VALUES ('121', 'admin', '127.0.0.1', '内网IP', 'Chrome 13', 'Windows 10', '0', '登录成功', '2025-07-09 15:32:34');
INSERT INTO `sys_logininfor` VALUES ('122', 'admin', '127.0.0.1', '内网IP', 'Chrome 13', 'Windows 10', '0', '登录成功', '2025-07-09 15:33:37');
INSERT INTO `sys_logininfor` VALUES ('123', 'admin', '127.0.0.1', '内网IP', 'Chrome 13', 'Windows 10', '0', '登录成功', '2025-07-09 15:35:53');
INSERT INTO `sys_logininfor` VALUES ('124', 'admin', '127.0.0.1', '内网IP', 'Chrome 13', 'Windows 10', '0', '登录成功', '2025-07-09 15:36:27');
INSERT INTO `sys_logininfor` VALUES ('125', 'admin', '127.0.0.1', '内网IP', 'Chrome 13', 'Windows 10', '0', '登录成功', '2025-07-09 15:47:46');
INSERT INTO `sys_logininfor` VALUES ('126', 'admin', '127.0.0.1', '内网IP', 'Chrome 13', 'Windows 10', '0', '登录成功', '2025-07-09 15:48:08');
INSERT INTO `sys_logininfor` VALUES ('127', 'admin', '127.0.0.1', '内网IP', 'Chrome 13', 'Windows 10', '0', '登录成功', '2025-07-09 15:58:19');
INSERT INTO `sys_logininfor` VALUES ('128', 'admin', '127.0.0.1', '内网IP', 'Chrome 13', 'Windows 10', '0', '登录成功', '2025-07-09 19:55:23');
...
CREATE TABLE `sys_menu` (
  ...
  PRIMARY KEY (`menu_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2019 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='菜单权限表';
...
INSERT INTO `sys_menu` VALUES ('2008', '数据仪表板', '0', '1', 'dashboard', 'Dashboard/index', null, '', '1', '0', 'M', '0', '0', 'system:dashboard:view', 'dashboard', 'admin', '2025-07-12 06:01:20', '', null, '数据仪表板菜单');
INSERT INTO `sys_menu` VALUES ('2009', '概览查看', '2008', '1', '', '', null, '', '1', '0', 'F', '0', '0', 'system:dashboard:overview', '#', 'admin', '2025-07-12 06:01:50', '', null, '仪表板概览查看');
INSERT INTO `sys_menu` VALUES ('2010', '趋势分析', '2008', '2', '', '', null, '', '1', '0', 'F', '0', '0', 'system:dashboard:trend', '#', 'admin', '2025-07-12 06:01:50', '', null, '访问趋势分析');
INSERT INTO `sys_menu` VALUES ('2011', '用户活动', '2008', '3', '', '', null, '', '1', '0', 'F', '0', '0', 'system:dashboard:activity', '#', 'admin', '2025-07-12 06:01:50', '', null, '用户活动分析');
INSERT INTO `sys_menu` VALUES ('2012', '下载分析', '2008', '4', '', '', null, '', '1', '0', 'F', '0', '0', 'system:dashboard:download', '#', 'admin', '2025-07-12 06:01:50', '', null, '下载分析');
INSERT INTO `sys_menu` VALUES ('2013', '热门文档', '2008', '5', '', '', null, '', '1', '0', 'F', '0', '0', 'system:dashboard:hot', '#', 'admin', '2025-07-12 06:01:50', '', null, '热门文档查看');
INSERT INTO `sys_menu` VALUES ('2014', '实时统计', '2008', '6', '', '', null, '', '1', '0', 'F', '0', '0', 'system:dashboard:realtime', '#', 'admin', '2025-07-12 06:01:50', '', null, '实时统计查看');
INSERT INTO `sys_menu` VALUES ('2015', '文档统计', '2008', '7', '', '', null, '', '1', '0', 'F', '0', '0', 'system:dashboard:document', '#', 'admin', '2025-07-12 06:01:50', '', null, '文档统计查看');
INSERT INTO `sys_menu` VALUES ('2016', '系统健康', '2008', '8', '', '', null, '', '1', '0', 'F', '0', '0', 'system:dashboard:health', '#', 'admin', '2025-07-12 06:01:50', '', null, '系统健康监控');
INSERT INTO `sys_menu` VALUES ('2017', '化学品统计', '2008', '9', '', '', null, '', '1', '0', 'F', '0', '0', 'system:dashboard:chemical', '#', 'admin', '2025-07-12 06:01:50', '', null, '化学品统计查看');
INSERT INTO `sys_menu` VALUES ('2018', '报告导出', '2008', '10', '', '', null, '', '1', '0', 'F', '0', '0', 'system:dashboard:export', '#', 'admin', '2025-07-12 06:01:50', '', null, '仪表板报告导出');
...
) ENGINE=InnoDB AUTO_INCREMENT=120 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='操作日志记录';
...
INSERT INTO `sys_oper_log` VALUES ('117', 'MSDS主信息', '3', 'com.ruoyi.web.controller.system.MsdsMainController.remove()', 'DELETE', '1', 'admin', '研发部门', '/system/msds/2', '127.0.0.1', '内网IP', '{}', '{\"msg\":\"操作成功\",\"code\":200}', '0', null, '2025-07-09 19:56:53', '2476');
INSERT INTO `sys_oper_log` VALUES ('118', 'MSDS主信息', '3', 'com.ruoyi.web.controller.system.MsdsMainController.remove()', 'DELETE', '1', 'admin', '研发部门', '/system/msds/1', '127.0.0.1', '内网IP', '{}', '{\"msg\":\"操作成功\",\"code\":200}', '0', null, '2025-07-09 19:56:57', '1332');
INSERT INTO `sys_oper_log` VALUES ('119', 'MSDS文档导入', '6', 'com.ruoyi.web.controller.system.MsdsMainController.importData()', 'POST', '1', 'admin', '研发部门', '/system/msds/import', '127.0.0.1', '内网IP', '{\"overwriteDuplicates\":\"false\"}', '{\"msg\":\"操作成功\",\"code\":200,\"data\":{\"duplicates\":[],\"errorMessages\":[],\"successCount\":1,\"failureCount\":0}}', '0', null, '2025-07-09 19:59:20', '3226');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '103', 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2025-07-09 19:55:23', 'admin', '2025-06-24 19:45:04', '', '2025-07-09 19:55:22', '管理员');
