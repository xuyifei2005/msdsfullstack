<template>
  <view class="about-detail-container">
    <!-- Glass Background -->
    ...
    <view class="content-wrapper">
      <view class="detail-card glass-card">
        <view class="about-title">{{ about.title }}</view>
        <view class="about-meta">
          <text class="date">{{ about.updateTime || about.createTime }}</text>
        </view>
        <view class="divider"></view>
        <view class="about-content">
          <u-parse :content="about.content" :selectable="true"></u-parse>
        </view>
      </view>
    </view>
  </view>
...
<script>
  export default {
    ...
    onLoad() {
      const about = uni.getStorageSync('currentAbout');
      if (about) {
        this.about = about;
      }
    }
